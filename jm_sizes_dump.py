"""COPY of jm_sizes.py that also saves per-cell volume and birth-time arrays to symbolic_runs/jm_sizes_samples_<seed>.npz."""
...
np.savez(os.path.join(HERE, "symbolic_runs", f"jm_sizes_samples_{seed_id}.npz"), vol=v, age=age)
